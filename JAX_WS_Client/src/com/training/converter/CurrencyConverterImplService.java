 ...
 * 
 */
@WebServiceClient(name = "CurrencyConverterImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:5000/converter?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CURRENCYCONVERTERIMPLSERVICE_QNAME = new QName("http://services.training.com/", "CurrencyConverterImplService");
    ...
    public CurrencyConverter getCurrencyConverterImplPort() {
        return super.getPort(new QName("http://services.training.com/", "CurrencyConverterImplPort"), CurrencyConverter.class);
    }
    ...
    public CurrencyConverter getCurrencyConverterImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.training.com/", "CurrencyConverterImplPort"), CurrencyConverter.class, features);
    }
