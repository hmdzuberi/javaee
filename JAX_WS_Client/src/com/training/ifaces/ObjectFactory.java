 ...
 * generated in the com.training.ifaces package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRequestResponse_QNAME = new QName("http://ifaces.training.com/", "getRequestResponse");
    private final static QName _BloodDonor_QNAME = new QName("http://ifaces.training.com/", "bloodDonor");
    private final static QName _GetRequest_QNAME = new QName("http://ifaces.training.com/", "getRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.training.ifaces
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ifaces.training.com/", name = "getRequestResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ifaces.training.com/", name = "bloodDonor")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ifaces.training.com/", name = "getRequest")
