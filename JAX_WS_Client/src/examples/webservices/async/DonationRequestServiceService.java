 ...
 * 
 */
@WebServiceClient(name = "DonationRequestServiceService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:5000/donor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DONATIONREQUESTSERVICESERVICE_QNAME = new QName("http://services.training.com/", "DonationRequestServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5000/donor?wsdl");
    ...
    public DonationRequest getDonationRequestServicePort() {
        return super.getPort(new QName("http://services.training.com/", "DonationRequestServicePort"), DonationRequest.class);
    }
    ...
    public DonationRequest getDonationRequestServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.training.com/", "DonationRequestServicePort"), DonationRequest.class, features);
    }
