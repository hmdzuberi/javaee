 ...
 * 
 */
@WebServiceClient(name = "SpiceJetService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:5005/SpiceJet?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SPICEJETSERVICE_QNAME = new QName("http://services.training.com/", "SpiceJetService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5005/SpiceJet?wsdl");
    ...
    public SeatAvailability getSpiceJetPort() {
        return super.getPort(new QName("http://services.training.com/", "SpiceJetPort"), SeatAvailability.class);
    }
     ...
     */
    @WebEndpoint(name = "SpiceJetPort")
    public SeatAvailability getSpiceJetPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.training.com/", "SpiceJetPort"), SeatAvailability.class, features);
    }
